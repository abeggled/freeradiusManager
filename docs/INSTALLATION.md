...
Die Kollation muss auf `_ci` enden – der Manager vergleicht Benutzer- und
Gruppennamen ohne Rücksicht auf Gross- und Kleinschreibung. Die RADIUS-Tabellen
erben sie beim Schema-Import; die `mgr_`-Tabellen richtet Migration `0010`
daran aus, damit Abfragen über beide Seiten funktionieren.
